package com.zprmts.tcc.ecommerce.constants;
...
public class ErrorMessage {
    ...
    public static final String ADRESS_CANNOT_BE_EMPTY = "Address cannot be empty";
    public static final String PHONE_NUMBER_CANNOT_BE_EMPTY = "Phone Number cannot be empty";
    public static final String POST_INDEX_CANNOT_BE_EMPTY = "Post Index cannot be empty";
